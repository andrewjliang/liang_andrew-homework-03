...
busdata %>%
  ...
  geom_point(position = position_jitter(width = 0.05), size = 2, na.rm = T) +
  ...
  geom_vline(xintercept = 1, linewidth = 2, alpha = 0.3) +
  geom_vline(xintercept = 1.5, linewidth = 3, linetype = "dashed", color = "yellow3") +
  geom_vline(xintercept = 2, linewidth = 2, alpha = 0.3) +
  annotate("rect", xmin = 1.15, xmax = 1.35, ymin = -43, ymax = -10, fill = "red") +
  annotate("rect", xmin = 1.73, xmax = 1.93, ymin = -8, ymax = 30, fill = "aquamarine") +
  annotate("rect", xmin = 1, xmax = 2, ymin = -50, ymax = 150, alpha = 0.3, fill = "darkgray") +
