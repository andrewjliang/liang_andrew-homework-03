...
busdata %>%
  ...
  annotate("rect", xmin = 1.1, xmax = 1.3, ymin = -43, ymax = -10, fill = "aquamarine") +
  annotate("rect", xmin = 1.6, xmax = 1.8, ymin = -8, ymax = 30, fill = "aquamarine") +
...
![T-Test](images/Screenshot%202024-04-24%20at%2011.37.10%20PM.png)
